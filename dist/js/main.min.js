...
function get(){
    send();
    document.getElementById("buttonmail").disabled = true;

  }
  
  
  async function send(){
    var email = document.getElementById("santamail").value
    var modal = document.getElementById("myModal");
    var text = document.getElementById("modaltext");

    if(email !== "" && email.contains("@") && email.contains(".")){
    var url = "https://santa-warehouse.ml/api/send?mail=" + email 
    ...
    modal.style.display = "block";
  text.value = "Your Email Seems Invalid :("
  }
  }
  ...
  async function send2(){
    var email = document.getElementById("santamail2").value
    var modal = document.getElementById("myModal");
    var text = document.getElementById("modaltext");
